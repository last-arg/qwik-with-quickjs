...
function polyfillFns(window) {
  window.setTimeout = function(fn, delay) {
      console.log("setTimeout polyfill not implemented")
    throw new Error("setTimeout polyfill not implemented");
  };
  window.clearTimeout = function(fn, delay) {
    console.log("clearTimeout polyfill not implemented");
    throw new Error("clearTimeout polyfill not implemented");
  };
  window.setInterval = function(fn, delay) {
    console.log("setInterval polyfill not implemented");
    throw new Error("setInterval polyfill not implemented");
  };
  window.clearInterval = function(id) {
    console.log("clearInterval polyfill not implemented");
    throw new Error("clearInterval polyfill not implemented");
  };
