...
pub const JsModuleLoader = struct {
    ...
    fn normalize(ctx: *JsContext, base: [*:0]const u8, name: [*:0]const u8, ptr: ?*anyopaque) callconv(.C) [*:0]const u8 {
        const self = @ptrCast(*@This(), @alignCast(@alignOf(*@This()), ptr.?));
        const f = self.*.normalizefn.?;
        return f(self, ctx, base, name);
    }

    fn trampoline(ctx: *JsContext, name: [*:0]const u8, ptr: ?*anyopaque) callconv(.C) ?*JsModuleDef {
        const self = @ptrCast(*@This(), @alignCast(@alignOf(*@This()), ptr.?));
...
pub const JsRuntime = opaque {
    ...
    pub fn setModuleLoader(self: *@This(), loader: *JsModuleLoader) void {
        JS_SetModuleLoaderFunc(
            ...
            @ptrCast(?*anyopaque, loader),
        );
    }

    pub fn setOpaque(self: *@This(), ptr: ?*anyopaque) void {
        JS_SetRuntimeOpaque(self, ptr);
    }

    pub fn getOpaque(self: *@This()) ?*anyopaque {
...
pub const JsValue = extern struct {
        ...
        const ret = if (is64bit)
            extern struct {
                ...
                pub fn transmit(val: T, tag: i64) u128 {
                    return @bitCast(u128, @This().init(val, tag));
                }
            ...
            bool, i32, usize => extern struct {
                ...
                pub fn transmit(val: T, tag: i32) u64 {
                    return @bitCast(u64, @This().init(val, tag));
                }
            ...
            f64 => extern struct {
                ...
                pub fn transmit(val: T, tag: i32) u64 {
                    return @bitCast(u64, @This().init(val, tag)) + (JS_FLOAT64_TAG_ADDEND << 32);
                }
    ...
    pub fn toString(self: @This(), ctx: *JsContext) @This() {
        return JS_ToString(ctx, self);
    }

    pub fn toPropertyKey(self: @This(), ctx: *JsContext) @This() {
    ...
    pub fn setOpaque(self: @This(), data: ?*anyopaque) void {
        JS_SetOpaque(self, data);
    }

    pub fn getOpaque(self: @This(), class_id: JsClassID) ?*anyopaque {
...
extern fn JS_GetRuntimeOpaque(rt: *JsRuntime) ?*anyopaque;
extern fn JS_SetRuntimeOpaque(rt: *JsRuntime, ptr: ?*anyopaque) void;
...
extern fn JS_SetOpaque(obj: JsValue, ptr: ?*anyopaque) void;
extern fn JS_GetOpaque(obj: JsValue, class_id: JsClassID) ?*anyopaque;
extern fn JS_GetOpaque2(ctx: *JsContext, obj: JsValue, class_id: JsClassID) ?*anyopaque;
...
const JsModuleNormalizeFunc = fn (*JsContext, [*:0]const u8, [*:0]const u8, ?*anyopaque) callconv(.C) [*:0]const u8;
const JsModuleLoaderFunc = fn (*JsContext, [*:0]const u8, ?*anyopaque) callconv(.C) ?*JsModuleDef;
extern fn JS_SetModuleLoaderFunc(rt: *JsRuntime, module_normalize: ?JsModuleNormalizeFunc, module_loader: JsModuleLoaderFunc, ptr: ?*anyopaque) void;
